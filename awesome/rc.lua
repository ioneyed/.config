...
local customGlobalKeys = awful.util.table.join(globalkeys,
  awful.key({ }, "XF86AudioMute", function()
    awful.util.spawn("amixer -q sset Master toggle")
    awful.util.spawn("amixer -q sset Speaker unmute")
    awful.util.spawn("amixer -q sset Headphone unmute")
  end
  ),
...
-- Custom Keys
  local customkeys = awful.util.table.join(
    )
-- }}}
